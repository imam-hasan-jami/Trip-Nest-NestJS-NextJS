...
const TransactionHistory: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      ...
      try {
        ...
        const response = await axios.get<Transaction[]>('http://localhost:3000/transaction-history/all', { headers });
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-blue-50">
      <div className="max-w-3xl w-full p-6 bg-blue rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-center text-black mb-4">Transaction History</h2>
        {loading && <p>Loading...</p>}
